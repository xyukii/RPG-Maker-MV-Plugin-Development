	/*
 * ==============================================================================
 * ** Yukii Module - Diagonal Movement
 * ------------------------------------------------------------------------------
 * Version History:
 *  v 1.00 > First release.
 *  v 1.01 > Compatibility with YEP Event Chase Player.
 * ==============================================================================
 */

    var Imported = Imported || {};
    Imported['Yukii - Diagonal Movement'] = '1.00';
    
    var YukiiModule = YukiiModule || {};
    YukiiModule.DiagonalMovement = YukiiModule.DiagonalMovement || {};
    
    (function() {
    
        YukiiModule.DiagonalMovement.loadDatabase = DataManager.loadDatabase;
        DataManager.loadDatabase = function() {
            YukiiModule.DiagonalMovement.loadDatabase.call(this);
            PluginManager.requiredPlugin.call(PluginManager, 'Yukii - Diagonal Movement', 'Yukii - Basic Module', '1.06');
        };
    
        YukiiModule.DiagonalMovement.requiredPlugin = PluginManager.requiredPlugin;
        PluginManager.requiredPlugin = function(name, required, version) {
            if (!YukiiModule.BasicModule) {
                var msg = 'The plugin ' + name + ' requires the plugin ' + required;
                msg += ' v' + version + ' or higher installed to work properly.';
                throw new Error(msg);
            } else {
                YukiiModule.DiagonalMovement.requiredPlugin.call(this, name, required, version)
            };
        };
    ...
    (function() {
        ...
        if (Imported['Yukii - Basic Module']) {
            var parameters = YukiiModule.getPluginParameters();
            YukiiModule.Parameters = YukiiModule.Parameters || {};
            YukiiModule.Parameters.DiagonalMovement = {};
            YukiiModule.Parameters.DiagonalMovement.DiagonalAdjust    = eval(parameters["Diagonal Adjust"]);
            YukiiModule.Parameters.DiagonalMovement.DiagonalEvents    = eval(parameters["Diagonal Events"]);
            YukiiModule.Parameters.DiagonalMovement.DiagonalFix       = eval(parameters["Diagonal Fix"]);
            YukiiModule.Parameters.DiagonalMovement.DiagonalTrigger   = eval(parameters["Diagonal Trigger"]);
            YukiiModule.Parameters.DiagonalMovement.CornerPassability = eval(parameters["Corner Passability"]);
        };
        ...
        YukiiModule.DiagonalMovement.initMembers = Game_CharacterBase.prototype.initMembers;
        Game_CharacterBase.prototype.initMembers = function() {
            YukiiModule.DiagonalMovement.initMembers.call(this);
            this._diagonal = 0;
        };
        
        YukiiModule.DiagonalMovement.moveStraight = Game_CharacterBase.prototype.moveStraight;
        Game_CharacterBase.prototype.moveStraight = function(d) {
            if (this.isDiagonalEnabled() && d % 2 !== 0) {
                ...
                this._diagonal = 0;
                YukiiModule.DiagonalMovement.moveStraight.call(this, d);
            }
        };
        
        YukiiModule.DiagonalMovement.characterIndex = Game_CharacterBase.prototype.characterIndex;
        Game_CharacterBase.prototype.characterIndex = function() {
            var adjust = (this.isDiagonal() && this.isDiagonalCharacter()) ? 1 : 0;
            return YukiiModule.DiagonalMovement.characterIndex.call(this) + adjust;
        };
        
        YukiiModule.DiagonalMovement.moveDiagonally = Game_CharacterBase.prototype.moveDiagonally;
        Game_CharacterBase.prototype.moveDiagonally = function(horz, vert) {
            if (this.isDiagonalEnabled()) this.setDiagonalDirection(horz, vert);
            YukiiModule.DiagonalMovement.moveDiagonally.call(this, horz, vert);
        ...
        YukiiModule.DiagonalMovement.distancePerFrame = Game_CharacterBase.prototype.distancePerFrame;
        Game_CharacterBase.prototype.distancePerFrame = function() {
            var distance = YukiiModule.DiagonalMovement.distancePerFrame.call(this);
            var adjust   = YukiiModule.Parameters.DiagonalMovement.DiagonalAdjust;
            if (adjust && this.isDiagonal()) distance /= Math.sqrt(2);
            return distance
        };
        
        YukiiModule.DiagonalMovement.canPassDiagonally = Game_CharacterBase.prototype.canPassDiagonally;
        Game_CharacterBase.prototype.canPassDiagonally = function(x, y, horz, vert) {
            if (YukiiModule.Parameters.DiagonalMovement.CornerPassability) {
                return YukiiModule.DiagonalMovement.canPassDiagonally.call(this, x, y, horz, vert)
            } else {
        ...
        YukiiModule.DiagonalMovement.copyPosition = Game_CharacterBase.prototype.copyPosition;
        Game_CharacterBase.prototype.copyPosition = function(character) {
            YukiiModule.DiagonalMovement.copyPosition.call(this, character);
            this._diagonal = character._diagonal
            this._diagonalEnabled = character._diagonalEnabled
            this.diagonalDirection();
        };
            
        YukiiModule.DiagonalMovement.checkEventTriggerTouchFront = Game_CharacterBase.prototype.checkEventTriggerTouchFront;
        Game_CharacterBase.prototype.checkEventTriggerTouchFront = function(d) {
            if (YukiiModule.Parameters.DiagonalMovement.DiagonalTrigger && d % 2 !== 0){
                var horz = ((d === 1 || d === 7) ? 4 : 6);
                var vert = ((d === 1 || d === 3) ? 2 : 8);
                ...
                YukiiModule.DiagonalMovement.checkEventTriggerTouchFront.call(this, d)
            }				
        };
        ...
        YukiiModule.DiagonalMovement.moveRandom = Game_Character.prototype.moveRandom;
        Game_Character.prototype.moveRandom = function() {
            ...
            if (this.isDiagonalEnabled() && direction % 2 !== 0 && direction !== 5) {
                ...
                YukiiModule.DiagonalMovement.moveRandom.call(this);
            };
        };
    
        
        YukiiModule.DiagonalMovement.moveTowardCharacter = Game_Character.prototype.moveTowardCharacter;
        Game_Character.prototype.moveTowardCharacter = function(character) {
            ...
            if (this.isDiagonalEnabled() && deltaX !== 0 && deltaY !==  0 && 
                ...
                YukiiModule.DiagonalMovement.moveTowardCharacter.call(this, character);
            };
        };
        
        YukiiModule.DiagonalMovement.moveAwayFromCharacter = Game_Character.prototype.moveAwayFromCharacter;
        Game_Character.prototype.moveAwayFromCharacter = function(character) {
            ...
            if (this.isDiagonalEnabled() && deltaX !== 0 && deltaY !==  0 && 
                ...
                YukiiModule.DiagonalMovement.moveAwayFromCharacter.call(this, character);
            };
        };
        
        YukiiModule.DiagonalMovement.turnTowardCharacter = Game_Character.prototype.turnTowardCharacter;
        Game_Character.prototype.turnTowardCharacter = function(character) {
            ...
            if (this.isDiagonalEnabled() && deltaX !== 0 && deltaY !==  0) {
                ...
                this._diagonal = 0;
                YukiiModule.DiagonalMovement.turnTowardCharacter.call(this, character);
            };
        };
    
        YukiiModule.DiagonalMovement.turnAwayFromCharacter = Game_Character.prototype.turnAwayFromCharacter;
        Game_Character.prototype.turnAwayFromCharacter = function(character) {
            ...
            if (this.isDiagonalEnabled() && deltaX !== 0 && deltaY !==  0) {
                ...
                this._diagonal = 0;
                YukiiModule.DiagonalMovement.turnAwayFromCharacter.call(this, character);
            };
        };
        
        YukiiModule.DiagonalMovement.moveForward = Game_Character.prototype.moveForward;
        Game_Character.prototype.moveForward = function() {
            if (this.isDiagonal()) {
                ...
                YukiiModule.DiagonalMovement.moveForward.call(this);
            }
        };
        ...
        Game_Character.prototype.needDiagonalFix = function() {
            return (!this.isMoving() && YukiiModule.Parameters.DiagonalMovement.DiagonalFix);
        };
        ...
        YukiiModule.DiagonalMovement.gamePlayerinitMembers = Game_Player.prototype.initMembers;
        Game_Player.prototype.initMembers = function() {
            YukiiModule.DiagonalMovement.gamePlayerinitMembers.call(this);
            this.setDiagonalOn();
        };
        
        YukiiModule.DiagonalMovement.getInputDirection = Game_Player.prototype.getInputDirection;
        Game_Player.prototype.getInputDirection = function() {
            if (this.isDiagonalEnabled()) {
                return Input.dir8;
            } else {
                return YukiiModule.DiagonalMovement.getInputDirection.call(this);
            };
        };
        
        YukiiModule.DiagonalMovement.executeMove = Game_Player.prototype.executeMove;
        Game_Player.prototype.executeMove = function(direction) {
            if (direction % 2 !== 0) {
                ...
                this._diagonal = 0;
                YukiiModule.DiagonalMovement.executeMove.call(this, direction);
            };
        };
        
        YukiiModule.DiagonalMovement.checkEventTriggerThere = Game_Player.prototype.checkEventTriggerThere;
        Game_Player.prototype.checkEventTriggerThere = function(triggers) {
            if (YukiiModule.Parameters.DiagonalMovement.DiagonalTrigger && this.isDiagonal()){
                ...
                YukiiModule.DiagonalMovement.checkEventTriggerThere.call(this, triggers);
            }
        };
        ...
        YukiiModule.DiagonalMovement.clearPageSettings = Game_Event.prototype.clearPageSettings;
        Game_Event.prototype.clearPageSettings = function() {
            YukiiModule.DiagonalMovement.clearPageSettings.call(this);
            this.setDiagonalOff();
        };
    
        YukiiModule.DiagonalMovement.setupPageSettings = Game_Event.prototype.setupPageSettings;
        Game_Event.prototype.setupPageSettings = function() {
            YukiiModule.DiagonalMovement.setupPageSettings.call(this);
            this.enableDiagonalEvent();
            this.disableDiagonalEvent();
        };
            
        YukiiModule.DiagonalMovement.lock = Game_Event.prototype.lock;
        Game_Event.prototype.lock = function() {
            this._prelockDiagonal = this._diagonal;
            YukiiModule.DiagonalMovement.lock.call(this);
        };
        
        YukiiModule.DiagonalMovement.unlock = Game_Event.prototype.unlock;
        Game_Event.prototype.unlock = function() {
            this._diagonal = this._prelockDiagonal;
            YukiiModule.DiagonalMovement.unlock.call(this);
        };
            
        Game_Event.prototype.enableDiagonalEvent = function() {
            var regex = new RegExp('<diagonal[ ]*move>', 'gi');
            var note  = YukiiModule.getPageNotes(this)
            if (YukiiModule.Parameters.DiagonalMovement.DiagonalEvents || regex.test(note)) {
                this.setDiagonalOn();
            };
        };	
        ...
        YukiiModule.DiagonalMovement.pluginCommand = Game_Interpreter.prototype.pluginCommand;
        Game_Interpreter.prototype.pluginCommand = function(command, args) {
            YukiiModule.DiagonalMovement.pluginCommand.call(this, command, args);
        ...
        YukiiModule.DiagonalMovement.isImageChanged = Sprite_Character.prototype.isImageChanged;
        Sprite_Character.prototype.isImageChanged = function() {
            return (this._isDiagonal !== this._character.isDiagonal() ||
                    YukiiModule.DiagonalMovement.isImageChanged.call(this));
        }
            
        YukiiModule.DiagonalMovement.setCharacterBitmap = Sprite_Character.prototype.setCharacterBitmap;
        Sprite_Character.prototype.setCharacterBitmap = function() {
            this._isDiagonal = this._character.isDiagonal();
            YukiiModule.DiagonalMovement.setCharacterBitmap.call(this);
        };
